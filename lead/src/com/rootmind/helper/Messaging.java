...
public class Messaging {
  ...
  private static JsonObject buildOverrideMessage(String token) {
	    JsonObject jNotificationMessage = buildNotificationMessage(token);
  ...
  public static void sendCommonMessage(String token) throws IOException {
	    JsonObject notificationMessage = buildNotificationMessage(token);
	    System.out.println("FCM request body for message using common notification object:");
	    prettyPrint(notificationMessage);
	    sendMessage(notificationMessage);
  }
  ...
  private static JsonObject buildNotificationMessage(String token) {
	    JsonObject jNotification = new JsonObject();
	    jNotification.addProperty("title", TITLE);
	    jNotification.addProperty("body", BODY);
